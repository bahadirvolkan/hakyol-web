...
(function () {
  ...
  var I18N = {
    tr: { h: "Bugünün Namaz Vakitleri", near: "En yakın", loading: "Vakitler hesaplanıyor…",
      ...
      disc: "Bu vakitler tahminidir; bölgenizin resmî vakitleriyle birkaç dakika farklılık gösterebilir. Kesin vakitler ve ezan/bildirim hatırlatması için Hakyol uygulamasını indirin." },
    en: { h: "Today's Prayer Times", near: "Nearest", loading: "Calculating times…",
      ...
      disc: "These times are estimates and may differ from your area's official times by a few minutes. Download the Hakyol app for accurate times and adhan/notification reminders." },
    ar: { h: "مواقيت الصلاة اليوم", near: "الأقرب", loading: "جارٍ حساب المواقيت…",
      ...
      disc: "هذه المواقيت تقديرية وقد تختلف عن المواقيت الرسمية في منطقتك بدقائق. حمّل تطبيق حاكيول للمواقيت الدقيقة وتنبيهات الأذان والإشعارات." },
    fa: { h: "اوقات نماز امروز", near: "نزدیک‌ترین", loading: "در حال محاسبه اوقات…",
      ...
      disc: "این اوقات تقریبی است و ممکن است چند دقیقه با اوقات رسمی منطقه شما تفاوت داشته باشد. برای اوقات دقیق و یادآوری اذان، برنامه حاکیول را دانلود کنید." },
    ur: { h: "آج کی نماز کے اوقات", near: "قریب ترین", loading: "اوقات کا حساب لگایا جا رہا ہے…",
      ...
      disc: "یہ اوقات تخمینی ہیں اور آپ کے علاقے کے سرکاری اوقات سے چند منٹ مختلف ہو سکتے ہیں۔ درست اوقات اور اذان/نوٹیفکیشن یاد دہانی کے لیے حاکیول ایپ ڈاؤن لوڈ کریں۔" },
    bn: { h: "আজকের নামাজের সময়", near: "নিকটতম", loading: "সময় গণনা করা হচ্ছে…",
      ...
      disc: "এই সময়গুলো আনুমানিক এবং আপনার এলাকার সরকারি সময়ের সাথে কয়েক মিনিট পার্থক্য হতে পারে। সঠিক সময় ও আজান/নোটিফিকেশন রিমাইন্ডারের জন্য Hakyol অ্যাপ ডাউনলোড করুন।" },
    id: { h: "Jadwal Salat Hari Ini", near: "Terdekat", loading: "Menghitung waktu…",
      ...
      disc: "Waktu ini adalah perkiraan dan dapat berbeda beberapa menit dari waktu resmi daerah Anda. Unduh aplikasi Hakyol untuk waktu akurat dan pengingat adzan/notifikasi." }
  };
